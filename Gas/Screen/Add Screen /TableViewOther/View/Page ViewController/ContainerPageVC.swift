...
class ContainerPageVC: UIViewController {
...
extension ContainerPageVC: UIPageViewControllerDelegate {
//    func pageViewController(_ pageViewController: UIPageViewController, didFinishAnimating finished: Bool, previousViewControllers: [UIViewController], transitionCompleted completed: Bool) {
//        if finished {
//            if completed {
//                guard let vc = pageViewController.viewControllers?[0] as? FullScreenImageVC else { return }
//                var ind: Int
//                ind = getVCPageIndex(vc)
//
//                // protocol luot sang mh khac
//            }
//
//        }
//    }
