...
class Location: Decodable, Hashable {
    ...
    init( elem: LocationElement?, asset: GetAsset?, createdAt: String?) { //,
        //    self.type = type
        self.elem = elem
        self.asset = asset
...
// MARK: - PurpleMetadata
class PurpleMetadata: Decodable {
